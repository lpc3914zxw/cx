...
final class Data
{
     ...
     * @return array
     */
    static public function channelLevel($data, $pid = 0, $html = "&nbsp;", $fieldPri = 'cid', $fieldPid = 'parent_id', $level = 1)
    {
        if (empty($data)) {
            return array();
        }
     ...
     * @return array
     */
    static public function channelList($data, $pid = 0, $html = "&nbsp;", $fieldPri = 'cid', $fieldPid = 'parent_id', $level = 1)
    {
    ...
    //只供channelList方法使用
    static private function _channelList($data, $pid = 0, $html = "&nbsp;", $fieldPri = 'cid', $fieldPid = 'parent_id', $level = 1)
    {
        if (empty($data))
            return array();
        $arr = array();
     ...
     * @return array
     */
    static public function tree($data, $title, $fieldPri = 'cid', $fieldPid = 'parent_id')
    {
     ...
     * @return array
     */
    static public function parentChannel($data, $sid, $fieldPri = 'cid', $fieldPid = 'parent_id')
    {
        if (empty($data)) {
            return $data;
        } else {
     ...
     * @return bool
     */
    static function isChild($data, $sid, $pid, $fieldPri = 'cid', $fieldPid = 'parent_id')
    {
     ...
     * @return bool
     */
    static function hasChild($data, $cid, $fieldPid = 'parent_id')
    {
        foreach ($data as $d) {
