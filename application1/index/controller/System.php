    ...
    public function appSet() {
        ...
        if($this->request->isPost()) {
            ...
            $data = [
                ...
                'start_level_content'=>$params['start_level_content'],
              ...
              'longcontent'=>$params['longcontent'],
              'stop_starttime'=>$params['stop_starttime'],
              'stop_endtime'=>$params['stop_endtime'],
              'stop_content'=>$params['stop_content'],
              'invite_class_content'=>$params['invite_class_content'],
